...
fpl = first_plus_length([1,2,3,4,5])
print(fpl)
...
#  greater than its 2nd value. Print how many values this is and then return the new list. If the list has less than 2 elements, have the function 
# return False
...
vgt = values_greater_than_second([5,2,3,2,1,4])
print(vgt)
